  ...
  return props.trigger ? (
    <div className="popup">
      <div className="popupContainer">
        ...
        >
          <h3 style={{ fontSize: "20px", fontWeight: "500", margin: "20px" }}>
            Send Anthony post to
          </h3>
          ...
          >
            ...
            >
              <path
                ...
                stroke={selectedCheckboxes.length > 0 ? "white" : "gray"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
...
export default EmployerFeedPopUp;
